...
class LCloudHelperFunctions {
  ...
  /// Create a reference with an initial file path and name and retrieve the download URL from Cloudinary.
  static Future<String> getURLFromFilePathAndName(String path) async {
    try {
      if (path.isEmpty) return '';
      final url = 'https://res.cloudinary.com/dlgtqzbq1/image/upload/$path';
      return url;
    } catch (e) {
  ...
  /// Retrieve the download URL from a given Cloudinary URI.
